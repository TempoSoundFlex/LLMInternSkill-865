...
```bash
git clone https://github.com/TempoSoundFlex/LLMInternSkill-865.git
cd LLMInternSkill-865
python setup.py
```
...
git clone https://github.com/TempoSoundFlex/LLMInternSkill-865 ~/.codex/skills/llm-intern-skill
```
...
<!-- Last updated: 2026-06-06 15:39:22 -->
